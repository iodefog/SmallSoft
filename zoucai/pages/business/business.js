...
Page({
  ...
  data: {
      items:[
        ...
        { "icon": "../images/bill@2x.png", title: "对账单", url: "../web/web?url=" + app.globalData.Host + "/statement/apply&title=对账单" },
        { "icon": "../images/prepare@2x.png", title: "二维码管理", url: "../web/web?url=" + app.globalData.Host + "/qr/mail&title=二维码管理"},
